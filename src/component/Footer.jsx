      ...
      <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="">
            ...
            <p>
            Setiap individu memiliki potensi tak terbatas. Melalui pendidikan yang berkualitas, kita memberikan mereka sayap untuk terbang menuju puncak kesuksesan.
            </p>
          </div>
          {/* <!-- Products section --> */}
          <div class="">
